        ...
        {posts.map((post) => (
          ...
          >
            <div className="flex justify-between items-center">
              ...
              <span className="text-neutral-400 dark:text-neutral-500 font-mono text-sm">{post.date}</span>
            </div>
            <p className="text-neutral-600 dark:text-neutral-400 text-sm mt-2">{post.excerpt}</p>
          </Link>
        ))}
      </div>
    </main>
