...
function SectionHeader({ ghost, label }: { ghost: string; label: string }) {
  return (
    <div className="mb-10">
      ...
      <h2 className="-mt-4 md:-mt-6 pl-1 font-mono text-xs md:text-sm uppercase tracking-[0.16em] text-stone-500 dark:text-stone-400">
        {label}
      </h2>
    </div>
  );
    ...
    <main className="flex flex-1 flex-col">
      ...
      <section id="work" className="w-full scroll-mt-24">
        ...
        <Reveal delay={0.1} className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Beakyn */}
          <div className="group flex flex-col gap-3 p-6 rounded-2xl border border-stone-200 dark:border-stone-800 bg-paper dark:bg-stone-950 hover:border-stone-400 dark:hover:border-stone-600 transition-colors">
          ...
          {/* Ontic2 / Compliance */}
          <div className="group flex flex-col gap-3 p-6 rounded-2xl border border-stone-200 dark:border-stone-800 bg-paper dark:bg-stone-950 hover:border-stone-400 dark:hover:border-stone-600 transition-colors">
            <AsciiArtCanvas art="USmap" source="smartscout." speed={1} background="#121212" color="#faf9f7" ripple clickable />
          </div>
        </Reveal>
      </section>
