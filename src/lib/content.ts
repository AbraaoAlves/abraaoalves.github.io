...
export const CONTENT: Record<Lang, LangContent> = {
  ...
  pt: {
    ...
    geo: {
      ...
      body: "Por nove anos fui dono do mapa interativo no coração do SmartScout — uma plataforma de inteligência geográfica de audiência — renderizando mais de 100.000 registros de dados reativos no navegador sem perder um frame. Resolver problemas que vivem no mapa é o que faço de melhor.",
    ...
    work: {
      ...
      items: [
        {
          ...
          year: "2017 — 2026",
          desc: "Membro fundador do time de engenharia no Brasil. Fui dono de um único produto de ponta a ponta em todo o seu ciclo: protótipo → MVP → licenciamento (2017) → exclusividade → aquisição (2025) → migração enterprise para a OUTFRONT (2026). Um ponto de vista raro para entender como decisões arquiteturais envelhecem.",
          bullets: [
            "Arquitetei a reconstrução do mapa interativo em React — redux-saga + web workers domando mais de 100.000 registros de dados reativos no cliente sob real pressão de memória.",
            "Migrei a UX de filtros planos para 200+ personas pré-computadas e redesenhei a camada de consulta — reduzindo a latência de 10s para menos de 800ms.",
            "Projetei um pipeline de dados serverless em Go que roda de forma autônoma há mais de 2 anos, após treinar o time para assumi-lo.",
            "Construí a fundação de DX de 2018 — CI/CD, ambientes de preview por PR, devcontainers — em produção até hoje, sete anos depois.",
          ],
        },
        {
          ...
          year: "2025 — 2026",
          desc: "Liderei a migração completa do produto SmartScout para o ambiente enterprise da OUTFRONT, em parceria com o time interno até o handoff da aquisição.",
          bullets: [
            ...
            "Conduzi a prontidão para aquisição — hardening, observabilidade e alinhamento arquitetural — e fui dono da documentação e do suporte pós-migração até o handoff.",
          ],
        },
        {
          ...
          year: "2014 — 2016",
          desc: "Fundei uma plataforma de doação mobile-first construída sobre a nota fiscal eletrônica brasileira. Fui dono de toda a stack — UI Ionic, APIs Node.js, MongoDB, OCR — sem PM ou designer dedicado.",
          bullets: [
      ...
      migLabel: "CINCO MIGRAÇÕES, LIDERADAS DE PONTA A PONTA",
      migrations: [
        { from: "JavaScript", to: "TypeScript", why: "Type safety e convenções, no primeiro ano." },
        { from: "Aurelia", to: "React", why: "Abriu um pool de talentos muito maior." },
        { from: "Monolito", to: "Serverless", why: "Removeu gargalos de escala." },
        { from: "Node.js", to: "Go", why: "Para pipelines intensivos em dados." },
        { from: "Infra interna", to: "OUTFRONT", why: "Ambiente enterprise completo." },
      ],
    },
    stack: {
      eyebrow: "FERRAMENTAS",
    ...
    ment: {
      ...
      ghost: "MENTOR",
      title: "Mentoria",
      body: "Treinei novas contratações de engenharia na Beakyn, desenhei o processo de entrevista técnica desde o primeiro ano e ensinei externamente como instrutor de programação meio-período — alimentando o pipeline de contratação com candidatos qualificados. Formar engenheiros é o trabalho do qual mais me orgulho.",
      quotes: [
        { t: "Trabalhar com o Abraão é saber que sua fundação de engenharia está em boas mãos. Tive o privilégio de ver seu crescimento — evoluindo de desenvolvedor pleno ao arquiteto de software responsável por toda a nossa autenticação.", by: "Sobre mentorar Hiléo Andersson" },
        { t: "Sua contribuição vai muito além de entregar código funcional. Ele é um daqueles raros profissionais que combina uma forte mentalidade product-first com rigor técnico impecável.", by: "Sobre mentorar Lamartine" },
      ],
    },
    roots: {
      eyebrow: "A FUNDAÇÃO",
      ghost: "ROOTS",
      title: "Origem",
      p1: "Não comecei pela web. Em 2002 fiz um curso técnico em eletrônica e aprendi <b>Assembly e microcontroladores pic8051</b> — contando ciclos de clock, brigando por cada byte. Meu primeiro emprego veio em 2004; a transição para a engenharia de software veio em 2008.",
      p2: "Esse início em baixo nível ainda molda como trabalho. Me ensinou cedo que a evolução das linguagens é, em grande parte, sobre restringir nossa capacidade de escrever código não-sustentável — e que <em>o software precisa ser entendido por humanos primeiro.</em> Se um time não consegue ler e julgar o código, a arquitetura falhou, por mais engenhosa que pareça.",
      timeline: [
      ...
      beyond: [
        ["♟", "Xadrez — praticando paciência estratégica."],
        ["𝄞", "Música clássica no contrabaixo acústico."],
        ["≈", "Nadando no mar com minhas filhas."],
      ],
    },
    lab: {
      eyebrow: "ESCRITA",
      ghost: "LAB",
      title: "Lab",
      body: "Notas sobre arquitetura, sistemas geoespaciais e o ofício de construir software feito para sobreviver ao seu primeiro autor.",
      items: [
        ["Em breve", "Renderizando 100k pontos sem perder um frame", "GEOESPACIAL"],
        ["Em breve", "Por que migrei um time inteiro de Aurelia para React", "ARQUITETURA"],
        ["Em breve", "Assembly me ensinou a ler código como humano", "OFÍCIO"],
      ],
      soon: "Rascunho",
    },
    contact: {
      eyebrow: "CONTATO",
      cta: "Vamos construir algo que perdura.",
      ctaLink: "Fale comigo",
      navH: "Navegar",
      connectH: "Conectar",
      emailH: "Email",
